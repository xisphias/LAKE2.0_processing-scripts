...
def preprocess_Atgasuk(wprecip,p_reduce):
    ...
    df_SM=plu.read_met_data('Atgasuk_lake_NS/South Meade.txt')
    ...
    df_met = pd.read_csv('Atgasuk_lake_NS/atqasuk-atq-2014-2015-meteorology-timeseries-calon.csv', encoding = "ISO-8859-1",usecols=[i for i in range(0,10)])
    ...
    [m,n]=df_met.shape
    print ('Atgasuk_lake_NS dimensions:',m,n)
    ...
    df_Atgasuk_data=plu.USGS2LAKE_met_data(df_met,"data/Atgasuk.dat",swe_full)
